...
3. If you need only the changed files for mobile apps in V10.2 check the update files in update files for apps from V10.1 to V10.2 folder. Please try to run this change log folder. 
